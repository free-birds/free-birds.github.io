define(["zepto.js", "common/msg.js", "util/url.js"], function($, msg, URL) {
    ...
    return function (dom) {
        ...
        $dom.click(function () {
            ...
            var pic = encodeURIComponent($dom.attr('data-share-pic') || $('imgs').attr('src'));
            ...
            if (ua == "touch") {
                ...
                msg.diy('<style>.msg-share{pointer-events: none}</style><imgs style="width:100%;" src="http://p0.meituan.net/mmc/de96e40c0c716a588aa935a8b61c677a24596.png"/>', null, {type: "share", closeOut: true, opacity: .7});
            }
        })
